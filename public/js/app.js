...
weatherForm.addEventListener('submit', (e) => {
	e.preventDefault(); //keeps page from refreshing when the button is clicked
	...
	//use fetch to display the weather conditions for the city entered
	...
	response.json().then((data) => {
		...
		else
		{
			...
			cityState.textContent = data.weather.city + ", " + data.weather.state;
			...
			message4.textContent = "Local " + data.weather.city + ", " + data.weather.state + " time:";
